...
- (void)viewDidLoad {
     ...
     */
    [[ZBURLSessionManager sharedManager]getRequestWithURL:home_URL target:self];
...
- (void)timer{
     ...
     *  请求下来的缓存会覆盖原有的缓存文件
     */
   [[ZBURLSessionManager sharedManager]getRequestWithURL:home_URL target:self apiType:ZBRequestTypeRefresh];
